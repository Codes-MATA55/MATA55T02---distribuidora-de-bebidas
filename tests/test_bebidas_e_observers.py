...
class TestCerveja(unittest.TestCase):
    ...
    def test_volume_negativo(self):
        with self.assertRaises(ValueError):
            Cerveja(nome="Original", volume_ml=-1, preco_unitario=4.50)

    def test_preco_negativo(self):
        with self.assertRaises(ValueError):
            Cerveja(nome="Original", volume_ml=350, preco_unitario=-1.0)

    def test_descricao_completa(self):
        c = Cerveja(nome="Original", volume_ml=350, preco_unitario=4.50)
...
class TestItemPedido(unittest.TestCase):
    ...
    def test_valor_total_calculado(self):
        c = Cerveja(nome="Original", volume_ml=350, preco_unitario=10.0)
