...
urlpatterns = [
    ...
    path('api/pedidos/<str:pedido_id>/separar/', views.pedido_separar, name='pedido_separar'),
    path('api/pedidos/<str:pedido_id>/expedir/', views.pedido_expedir, name='pedido_expedir'),
]